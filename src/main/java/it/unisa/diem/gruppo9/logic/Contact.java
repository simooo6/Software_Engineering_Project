...
public class Contact {
     ...
     * String
     * @post If no phone numbers are inserted the attribute phoneNumber is
     * initialized as an empty {@code Array}
     * @post If no emails are inserted the attribute email is initialized as an
     * empty {@code Array}
     *
     *
     *
     ...
     *
     * @return an array of email addresses, or {@code null} if no addresses are
     * set.
     */
