 ...
 * 
 * <p>
 * @invariant Data consistency: data saved via {@code saveContact()} must always be retrivable in
 * an equivalent and consistent format via {@code loadContact()} 
 * @invariant Storage integrity: the storage system must always remain in a consisted
 * and readable state
 * @invariant Data format compilance: any contacts saved or loaded must respect the format
 * defined by the program's logic
 * </p>
 * 
 * @see ContactManager
 * 
