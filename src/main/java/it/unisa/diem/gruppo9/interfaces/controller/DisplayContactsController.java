 ...
 * the contact list via GUI. It is linked to an FXML file called "ContactView.fxml"
 * located in the "it.unisa.diem.gruppo9.interfaces.view" package; 
 * the "@FXML" annotation can bind the UI components to the methods of this class.
 * </p>
 * 
 * <p>
 * The {@code DisplayContactsController} interacts with the 'ContactManager' giving
 * the user the possibility to: view, add, edit, delete, search for contacts and save changes.
 * The controller also give the user the possibility to handle the navigation between
 * different views in the application via interaction with 'ChangeView'.
 * </p>
 * 
 * <p>
 * @extends BaseController
 * The {@code DisplayContactsController} extends the {@code BaseController} class.
 ...
 * The {@code Initializable} interface defines the method {@code initialize} that is
...
public class DisplayContactsController extends BaseController implements Initializable{
    ...
    /**
     * Initializes the controller class. It is called automatically after the FXML file is loaded
    ...
    /**Handles the action of saving changes on the contact list (for the export of the contact list on file)
